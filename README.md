...
[Cilia_Lengths_2D.ijm](/Cilia_Lengths_2D.ijm) & [Cilia_Spots_2D.ijm](/Cilia_Spots_2D.ijm) were published in:
...
[IdentifyUpperSurfacev2.ijm](/IdentifyUpperSurfacev2.ijm) as used in:
...
[SphericityRoundnessConvexity.ijm](/SphericityRoundnessConvexity.ijm) published in:
...
[GlomActinSynaptov004vEV-6-UPDATESINGLEFILEFINAL.ijm](/GlomActinSynaptov004vEV-6-UPDATESINGLEFILEFINAL.ijm) &
[GlomActinSynaptov005vEV-UPDATEFOLDERFINAL.ijm](/GlomActinSynaptov005vEV-UPDATEFOLDERFINAL.ijm)
...
Individual cells were cropped by manually drawing an ellipse around the cell in the centre of the stack, this was then processed to a 3D spheroid mask using [SpherefromCirclev002.ijm](/SpherefromCirclev002.ijm) and the individual cell extracted.
Measurements of Mitotracker & MitoSox volumes, surface areas and intensities were calculated by thresholding deconvolved images using [MitoSoxWithTablev016.ijm](MitoSoxWithTablev016.ijm).
Outputs a results table summarizing all measurements, per cell and per mitochondrial structure.

Adapted macro for Radziszewska et al CD8 T-cell mitochondrial measurements: [MitoSoxWithTableAniav003.ijm](MitoSoxWithTableAniav003.ijm).
...
The macro is available here: [DAB_High_med_low_Hassanv05.ijm](DAB_High_med_low_Hassanv05.ijm).
...
The macro is available here: [BileCanaliculi_Assay_MacroV2.ijm](BileCanaliculi_Assay_MacroV2.ijm).
...
[ICH_Scalebars_Mag_anywhere_in_Filename_v5.ijm](ICH_Scalebars_Mag_anywhere_in_Filename_v06.ijm) and 
[ICH_scalebars_Mag_from_folder_v06.ijm](/ICH_scalebars_Mag_from_folder_v06.ijm)
...
[CZItoRGBFolder.ijm](/CZItoRGBFolder.ijm)
...
### **Combine 2, 3 or 4 separate colour images (or stacks) into colour composite image:**
 ...
 [4ChCompfromFilenamev006.ijm](/4ChCompfromFilenamev006.ijm)
 
 [3ChCompfromFilenamev006.ijm](/3ChCompfromFilenamev006.ijm)

 [2ChCompfromFilenamev006.ijm](/2ChCompfromFilenamev006.ijm)
